...
const Projects = () => {
	...
	return (
		<div id="Projects" className="bg-black py-10">
			<h1 className="text-5xl text-center py-10 pb-20">
				{" "}
				Latest projects
			</h1>
            ...
            <div className="flex flex-col md:flex-row-reverse  overflow-hidden  items-center ">
				<div data-aos="fade-left" className="  text-center md:w-1/2">
					<h1 className="text-2xl md:text-4xl mb-4">Topic Trove</h1>
					<p className="text-2xl md:text-4xl text-[#61CE70]">
						-----A forum Website ------
					</p>
				</div>

				<div className="md:w-1/2 w-screen p-10 md:mt-5 md:mx-auto">
					<Swiper
						slidesPerView={1}
						spaceBetween={30}
						loop={true}
            ...
            <div  className="flex flex-col md:flex-row items-center overflow-hidden ">
				<div data-aos="fade-right" className="  text-center md:w-1/2">
				...
				<div className="md:w-1/2 w-screen space-y-5 p-10 md:mt-5 md:mx-auto">
					<Swiper
						slidesPerView={1}
						spaceBetween={30}
						loop={true}
            ...
            <div className="flex flex-col md:flex-row-reverse items-center  overflow-hidden ">
				<div data-aos="fade-left"className=" text-center md:w-1/2">
					<h1 className="text-2xl md:text-4xl mb-4">Wedding Hub</h1>
					<p className="text-2xl md:file:text-4xl text-[#61CE70]">
						-----A Wedding service Website ------
					</p>
				</div>
